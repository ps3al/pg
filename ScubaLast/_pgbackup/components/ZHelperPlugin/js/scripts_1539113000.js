...
//	var scalableContainer = $(this).parent();
//    var scalableContainerWidth = scalableContainer.width() - 10;
//    var scalableWidth = $(this).width();

//		console.warn(parseInt($(this).css("font-size"))*2);
		$(this).clone().insertAfter($(this)).css({
			...
			"right": "0",
			"z-index": "0",
//			"font-size" : parseInt($(this).css("font-size"))*2
			"transform" : "scale(2)"			
//			"transform": "scale("+ scalableContainerWidth / scalableWidth +")"
		});
	});
