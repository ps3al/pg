(function($) {
	...
	// 	var swDefaults = {};
	// 	var swiperConf = $(this).data('swiper-container-options');
...
// var plyrx = $('.js-player');
// plyrx.each(function(index) {
// 	var plyrxDefaults = {};
// 	var plyrxOptions = $(this).data('plyr-options');
// //		var plyrx = $(this).Plyr($.extend(plyrxDefaults, plyrxOptions));
// //		var player = new Plyr($(this), $.extend(plyrxDefaults, plyrxOptions));
// //console.warn(plyrxOptions);
// //plyr.setup($(this), $.extend(plyrxDefaults, plyrxOptions));
// //plyr.setup($(this), plyrxOptions);
// //const players = Array.from(document.querySelectorAll('.js-player')).map(p => new Plyr(p,p.data('plyr-options')));
	...
	var $window = $(window),
		...
		$pluginInstance = $('.google-map').lazyLoadGoogleMaps({
			...
			callback: function(container, map) {
				...
				var x = $container.attr('data-googlemap-options') ? $container.attr('data-googlemaps-options') : "{}";
