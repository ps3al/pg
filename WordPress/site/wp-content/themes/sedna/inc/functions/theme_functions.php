...
if ( function_exists( 'vc_map' ) ) {
	...
	function rt_vc_multiple_select_forms( $param, $param_value ) {
	...
	vc_add_shortcode_param( 'dropdown_multi', 'rt_vc_multiple_select_forms', get_template_directory_uri() . '/inc/multiple-select.js' );
}
*/

function sm_breadcrumbs() {
