...
if ( !class_exists( 'SMSite1' ) ):

class SMSite1Theme extends SMThemeLoader {
...
//			include(SM_THEMELOADERDIR . "/classes/options.php");
	...
	function load_scripts(){
		...
		wp_enqueue_script('site1-js-plugins', SM_THEMEURI  . '/js/plugins.js', array('jquery'), "", "true" );
		wp_enqueue_script('site1-scripts', SM_THEMEURI  . '/js/main.js', 10000, "", "true" );
...
//		include(SM_THEMELOADERDIR . "/functions/theme_functions.php");
	...
	function create_menus() {
		...
		register_nav_menu( 'main-navigation', __( 'Main Navigation' , 'site1') );
