...
* Improved backend UI
* Improved sections list, keep previous position of scrolling
* Allows custom text of add new group field
* Removed some of bootstrap css conflict

= 2.4.3 (May 31, 2016) =

* Adding column class estimate by percent to do responsive
...
* Backend presets for all elements http://docs.kingcomposer.com/presets/
* Fix some css issues 
...
* Instant preview text block element when typing on FrontEnd editor
...
* Add dynamic image url for kc_box, editor, textarea
* Auto decode before return attribute value for fields editor, textarea, group


= 2.3 (May 17, 2016) =

* Quick preview beta of version 2.3 https://www.youtube.com/watch?v=BIhl0-ulvxY
* Change column width from grid to percent
* Resize columns more easier and flexible
...
* Add new field editor to replace field textarea_html
* Able to add more than 1 editor into element
...
* Add new feature to allow add icons font to icon picker. http://docs.kingcomposer.com/basic/import-icons/
...
* Add responsive options for Tabs Slider element
* Add new api functions for register assets for 3 party

= 2.1.2 (April 19, 2016) =

* add uncache for list elements to show addon
...
* Add autocomplete field http://docs.kingcomposer.com/available-param-types/autocomplete
* Cache to increase performance over 35%
* Fix pie char element
* Preview FrontEnd Editor
