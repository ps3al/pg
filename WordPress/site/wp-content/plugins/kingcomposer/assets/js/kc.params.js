		...
		fields : {
			...
			group : {
				...
				actions : function( e ){
					...
					if (target.hasClass('kc-group-controls') || target.hasClass('counter')) {
						...
						if( typeof values['kc-css'][s] == 'object' ){
							...
							for( g in values['kc-css'][s] ){ // loop group
								...
								if( typeof values['kc-css'][s][g] == 'object' ){ 
									...
									for( p in values['kc-css'][s][g] ){ // loop properties
										
										values['kc-css'][s][g][p] = values['kc-css'][s][g][p].toString().replace(/(?:\r\n|\r|\n)/g, '').replace(/\`/g,'');
